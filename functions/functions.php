<?php
 ...
 $db = mysqli_connect("localhost","root","","mift_store");
...
//          echo "<script> windows.open('shop.php','_self) </script>";
//       }
//       else{
...
//  }
 ...
 function search_product() {
   ...
   if(isset($_GET['search_data_product'])){
      ...
      $result_query = mysqli_query($db,$search_query);

      $num_of_rows = mysqli_num_rows($result_query);

      if($num_of_rows == 0){
         echo "<h2 class='text-center text-danger'>No result match.No products found in this category!</h2>";
      }
   ...
   if (isset($_GET['p_cat'])) {
       ...
       if ($count==0) {
         ...
         <div class='box'>
            ...
            <h1> No Product Found in the Product Category</h1>
...
function items() {
   ...
   $count_itmes = mysqli_num_rows($run_items);
